        ...
        <div class="glass-panel auth-card auth-card-wide">
            ...
            <div class="auth-image-side">
                <div style="position:relative; z-index:10;">
                    <a href="{{ route('home') }}" class="logo-creative" style="margin-bottom: 40px; display:inline-flex;">
            ...
            <div class="auth-form-side">
                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="creative-input-group">
                        ...
                        <input type="email" name="email" class="creative-input" placeholder="student@uoh.edu.sa" value="{{ old('email') }}" required autofocus>
                    </div>
                ...
                <div style="text-align: center; margin-top: 30px; font-size: 14px; color: rgba(255,255,255,0.6);">
                    ...
                    <a href="{{ route('register') }}" style="color: #fff; font-weight: 700; text-decoration: none; border-bottom: 2px solid #FF3366; padding-bottom: 2px;">Create account</a>
                </div>
