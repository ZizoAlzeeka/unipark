    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <table class="details-table">
                ...
                <tr>
                    <th>Role</th>
                    <td><span style="text-transform: capitalize;">{{ $reservation->user->role }}</span></td>
                </tr>
                <tr>
                    <th>Spot ID</th>
                    <td><strong style="color: #4f46e5;">{{ $reservation->spot->zone->code }}-{{ $reservation->spot->spot_number }}</strong></td>
                </tr>
                <tr>
                    <th>Start Time</th>
            ...
            <div style="text-align: center;">
                <a href="{{ route('admin.reservations.show', $reservation->id) }}" class="action-button">View in Admin Dashboard</a>
            </div>
        </div>
        <div class="footer">
