...
<body>
    ...
    <aside class="sidebar sidebar-new-theme" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item">
                <a href="<?php echo e(auth()->user()->isAdmin() ? route('admin.dashboard') : route('dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('dashboard') || request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
...
<?php /**PATH H:\MAMP\htdocs\unipark\resources\views/layouts/app.blade.php ENDPATH**/ ?>