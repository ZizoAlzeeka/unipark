...
<?php $__env->startSection('page-title', 'Permissions Management'); ?>
<?php $__env->startSection('page-subtitle', 'Control access and grant or deny permissions for each role'); ?>
            ...
            <table style="width:100%;border-collapse:separate;border-spacing:0;">
                <thead>
                    <tr>
                        ...
                        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <th style="padding:14px;background:rgba(108,99,255,0.04);border-bottom:2px solid var(--border-color);border-left:1px solid var(--border-color);text-align:center;">
                            <div style="display:flex;align-items:center;justify-content:center;gap:6px;">
                                <i class="fas <?php echo e($info['icon']); ?>" style="color:<?php echo e($info['color']); ?>;font-size:15px;"></i>
                                <span style="font-size:14px;font-weight:700;color:<?php echo e($info['color']); ?>;"><?php echo e(ucfirst($role)); ?></span>
                            </div>
                        </th>
                ...
                <tbody>
                    <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group => $permList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td colspan="4" style="padding:10px 20px;background:rgba(108,99,255,0.06);border-bottom:1px solid rgba(108,99,255,0.1);border-top:1px solid rgba(108,99,255,0.1);">
                            <span style="font-size:12px;font-weight:800;text-transform:uppercase;letter-spacing:0.8px;color:var(--primary);">
                                <i class="fas fa-folder" style="margin-right:6px;"></i><?php echo e($group); ?>

                            </span>
                        </td>
                    </tr>
                    <?php $__currentLoopData = $permList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permKey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr style="border-bottom:1px solid rgba(108,99,255,0.04);">
                        <td style="padding:14px 20px;">
                            <div style="font-size:14px;font-weight:600;color:var(--text-primary);"><?php echo e($permissionLabels[$permKey] ?? ucwords(str_replace('_',' ',$permKey))); ?></div>
                            <div style="font-size:12px;color:var(--text-muted);font-family:monospace;margin-top:2px;"><?php echo e($permKey); ?></div>
                        </td>
                        ...
                        <td style="border-left:1px solid var(--border-color);text-align:center;padding:14px;">
                            <div class="perm-toggle <?php echo e($granted ? 'active' : ''); ?>"
                                 onclick="togglePermission(this, '<?php echo e($role); ?>', '<?php echo e($permKey); ?>')"
                                 title="<?php echo e($granted ? 'Click to deny' : 'Click to grant'); ?>">
...
function togglePermission(el, role, permission) {
    ...
    fetch('<?php echo e(route('admin.permissions.toggle')); ?>', {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\MAMP\htdocs\unipark\resources\views/admin/permissions/index.blade.php ENDPATH**/ ?>