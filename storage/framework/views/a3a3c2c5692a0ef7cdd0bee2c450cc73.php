...
<body class="creative-layout">
    ...
    <div class="auth-wrapper">
        <div class="glass-panel auth-card" style="max-width: 540px; padding: 3rem;">
            ...
            <form action="<?php echo e(route('verification.verify')); ?>" method="POST" id="verifyForm">
                <?php echo csrf_field(); ?>
            ...
            <div style="text-align: center; margin-top: 24px;">
                <a href="<?php echo e(route('login')); ?>" style="font-size: 14px; color: rgba(255,255,255,0.5); text-decoration: none; transition: color 0.2s;">
...
</html><?php /**PATH H:\MAMP\htdocs\unipark\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>