...
<?php $__env->startSection('page-subtitle', 'Update user information for ' . $user->name); ?>
    ...
    <div class="card">
        <div class="card-header">
            <div style="display:flex;align-items:center;gap:14px;">
                <img src="<?php echo e($user->avatar_url); ?>" style="width:52px;height:52px;border-radius:50%;border:3px solid var(--primary);object-fit:cover;">
                <div>
                    <div class="card-title"><?php echo e($user->name); ?></div>
                    <p style="font-size:13px;color:var(--text-muted);"><?php echo e($user->email); ?></p>
                </div>
            </div>
        ...
        <form action="<?php echo e(route('admin.users.update', $user->id)); ?>" method="POST">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control" value="<?php echo e($user->email); ?>" readonly style="background:rgba(108,99,255,0.03);">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="university_id" class="form-control" value="<?php echo e(old('university_id', $user->university_id)); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="vehicle_plate" class="form-control" value="<?php echo e(old('vehicle_plate', $user->vehicle_plate)); ?>" style="text-transform:uppercase;">
                    </div>
                </div>
            ...
            <div class="form-group">
                <label style="display:flex;align-items:center;gap:10px;cursor:pointer;font-size:14px;font-weight:600;">
                    <input type="checkbox" name="is_active" value="1" <?php echo e($user->is_active ? 'checked' : ''); ?> style="accent-color:var(--primary);width:18px;height:18px;">
                    Account Active
                </label>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xamp\htdocs\unipark\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>