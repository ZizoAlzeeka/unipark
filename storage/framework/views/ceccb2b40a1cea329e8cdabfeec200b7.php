                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex;gap:6px;">
                                <a href="<?php echo e(route('admin.users.show', $user->id)); ?>" class="btn btn-ghost btn-icon" title="View">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="<?php echo e(route('admin.users.edit', $user->id)); ?>" class="btn btn-ghost btn-icon" title="Edit" style="color:var(--warning);">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="<?php echo e(route('admin.users.toggle-status', $user->id)); ?>" method="POST" style="display:inline;">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="btn btn-icon" title="<?php echo e($user->is_active ? 'Deactivate' : 'Activate'); ?>" style="background:<?php echo e($user->is_active ? 'rgba(239,71,111,0.08)' : 'rgba(6,214,160,0.08)'); ?>;color:<?php echo e($user->is_active ? 'var(--danger)' : 'var(--success)'); ?>;">
                                ...
                                <form action="<?php echo e(route('admin.users.destroy', $user->id)); ?>" method="POST" style="display:inline;">
                                    ...
                                    <button type="submit" class="btn btn-icon" style="background:rgba(239,71,111,0.08);color:var(--danger);" data-confirm="Delete user <?php echo e($user->name); ?>? This cannot be undone.">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xamp\htdocs\unipark\resources\views/admin/users/index.blade.php ENDPATH**/ ?>