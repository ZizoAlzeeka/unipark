...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2 class="greeting">Hello, <?php echo e($reservation->user->name); ?>!</h2>
            ...
            <div class="details-card">
                <div class="detail-row">
                    ...
                    <span class="detail-value"><span class="spot-highlight"><?php echo e($reservation->spot->zone->code); ?>-<?php echo e($reservation->spot->spot_number); ?></span></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Zone</span>
                    <span class="detail-value"><?php echo e($reservation->spot->zone->name); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Start Time</span>
                    <span class="detail-value"><?php echo e(\Carbon\Carbon::parse($reservation->start_time)->format('M d, Y h:i A')); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">End Time</span>
                    <span class="detail-value"><?php echo e(\Carbon\Carbon::parse($reservation->end_time)->format('M d, Y h:i A')); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Vehicle Plate</span>
                    <span class="detail-value"><?php echo e($reservation->vehicle_plate); ?></span>
                </div>
            </div>
            
            <div style="text-align: center; margin-top: 35px;">
                <a href="<?php echo e(route('reservations.show', $reservation->id)); ?>" class="action-button">View Reservation Details</a>
            </div>
        </div>
        <div class="footer">
            <p>Need help? Contact UniPark Support.</p>
            <p style="margin-top: 10px;">&copy; <?php echo e(date('Y')); ?> UniPark. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH H:\MAMP\htdocs\unipark\resources\views/emails/reservation-user.blade.php ENDPATH**/ ?>