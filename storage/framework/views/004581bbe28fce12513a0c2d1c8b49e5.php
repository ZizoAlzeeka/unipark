...
<body class="creative-layout">
        ...
        <div class="nav-container">
            ...
            <div style="display:flex; gap:16px; align-items:center;">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="btn-creative btn-creative-glass">
                        <i class="fas fa-tachometer-alt"></i> Dashboard
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn-creative btn-creative-glass" style="font-weight:600;">
                        Sign In
                    </a>
                    <a href="<?php echo e(route('register')); ?>" class="btn-creative btn-creative-primary">
    ...
    <section class="landing-hero">
        <div class="hero-content">
            ...
            <div style="display:flex; justify-content:center; gap:20px; flex-wrap:wrap;">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="btn-creative btn-creative-primary" style="padding:16px 40px; font-size:18px;">
                        Go to Dashboard
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('register')); ?>" class="btn-creative btn-creative-primary" style="padding:16px 40px; font-size:18px;">
                        <i class="fas fa-rocket"></i> Start Free Trial
                    </a>
                    <a href="<?php echo e(route('login')); ?>" class="btn-creative btn-creative-glass" style="padding:16px 40px; font-size:18px;">
                        Sign In Now
                    </a>
                <?php endif; ?>
            </div>
    ...
    <section style="padding:100px 5%; text-align:center; position:relative;">
        ...
        <div class="glass-panel" style="max-width:800px; margin:0 auto; padding:60px 40px; position:relative; z-index:10;">
            ...
            <a href="<?php echo e(route('register')); ?>" class="btn-creative btn-creative-primary" style="padding:18px 50px; font-size:18px;">
                Create Your Account
            </a>
        </div>
    </section>
    ...
    <footer style="text-align:center; padding:40px; color:rgba(255,255,255,0.4); font-size:14px; border-top:1px solid rgba(255,255,255,0.05); position:relative; z-index:10;">
        &copy; <?php echo e(date('Y')); ?> University of Ha'il. All rights reserved.
    </footer>

</body>
</html>
<?php /**PATH H:\MAMP\htdocs\unipark\resources\views/landing.blade.php ENDPATH**/ ?>