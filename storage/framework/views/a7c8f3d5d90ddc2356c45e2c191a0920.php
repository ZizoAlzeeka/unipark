...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="code-box">
                <p class="code"><?php echo e($verificationCode); ?></p>
            </div>
        ...
        <div class="footer">
            <p>&copy; <?php echo e(date('Y')); ?> UniPark. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH H:\MAMP\htdocs\unipark\resources\views/emails/verify-email.blade.php ENDPATH**/ ?>