...
<div>
    ...
    <div class="grid grid-4 mb-24">
        <div class="kpi-card-new bg-kpi-1 animate-fade-up stagger-1">
            ...
            <div class="kpi-info-new">
                <div class="kpi-value-new"><?php echo e(number_format($stats['total_users'])); ?></div>
        ...
        <div class="kpi-card-new bg-kpi-2 animate-fade-up stagger-2">
            ...
            <div class="kpi-info-new">
                <div class="kpi-value-new"><?php echo e(number_format($stats['active_reservations'])); ?></div>
                <div class="kpi-label-new">Active Reservations</div>
                <div style="font-size:12px;opacity:0.8;margin-top:4px;"><i class="fas fa-clock"></i> <?php echo e($stats['total_reservations_today']); ?> today</div>
            </div>
        </div>
        <div class="kpi-card-new bg-kpi-3 animate-fade-up stagger-3">
            <div class="kpi-icon-new"><i class="fas fa-clipboard-check"></i></div>
            <div class="kpi-info-new">
                <div class="kpi-value-new"><?php echo e($stats['available_spots']); ?></div>
                <div class="kpi-label-new">Available Spots</div>
                <div style="font-size:12px;opacity:0.8;margin-top:4px;">of <?php echo e($stats['total_spots']); ?> total</div>
            </div>
        </div>
        <div class="kpi-card-new bg-kpi-4 animate-fade-up stagger-4">
            <div class="kpi-icon-new"><i class="far fa-calendar-alt"></i></div>
            <div class="kpi-info-new">
                <div class="kpi-value-new"><?php echo e($stats['pending_violations']); ?></div>
    ...
    <div class="grid grid-4 mb-24">
        <div class="kpi-card-new bg-kpi-4">
            <div class="kpi-icon-new"><i class="fas fa-user-graduate"></i></div>
            <div class="kpi-info-new">
                <div class="kpi-value-new"><?php echo e($stats['total_students']); ?></div>
        ...
        <div class="kpi-card-new bg-kpi-3">
            ...
            <div class="kpi-info-new">
                <div class="kpi-value-new"><?php echo e($stats['total_staff']); ?></div>
        ...
        <div class="kpi-card-new bg-kpi-2">
            ...
            <div class="kpi-info-new">
                <div class="kpi-value-new"><?php echo e($stats['reserved_spots']); ?></div>
        ...
        <div class="kpi-card-new bg-kpi-1">
            ...
            <div class="kpi-info-new">
                <div class="kpi-value-new"><?php echo e($stats['total_zones']); ?></div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\MAMP\htdocs\unipark\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>