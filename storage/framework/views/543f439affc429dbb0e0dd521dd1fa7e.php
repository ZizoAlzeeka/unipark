    ...
    <div class="auth-wrapper">
        <div class="glass-panel auth-card" style="max-width: 600px; padding: 2.5rem;">
            ...
            <div style="text-align: center; margin-bottom: 30px;">
                <a href="<?php echo e(route('home')); ?>" class="logo-creative" style="justify-content: center; margin-bottom: 20px;">
            ...
            <form action="<?php echo e(route('register')); ?>" method="POST">
                ...
                <div class="creative-input-group">
                    ...
                    <input type="text" name="name" class="creative-input" placeholder="Your full name" value="<?php echo e(old('name')); ?>" required autofocus>
                </div>
                ...
                <div class="creative-input-group">
                    ...
                    <input type="email" name="email" class="creative-input" placeholder="student@uoh.edu.sa" value="<?php echo e(old('email')); ?>" required>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    <div class="creative-input-group">
                        ...
                        <select name="role" class="creative-input" required style="appearance: none; cursor: pointer; padding-left: 44px;">
                            ...
                            <option value="student" style="color: #000;" <?php echo e(old('role') == 'student' ? 'selected' : ''); ?>>🎓 Student</option>
                            <option value="staff" style="color: #000;" <?php echo e(old('role') == 'staff' ? 'selected' : ''); ?>>👨‍💼 Staff</option>
                        </select>
                    ...
                    <div class="creative-input-group">
                        ...
                        <input type="text" name="vehicle_plate" class="creative-input" placeholder="e.g. ABC-1234" value="<?php echo e(old('vehicle_plate')); ?>">
                    </div>
                </div>
            ...
            <div style="text-align: center; margin-top: 30px; font-size: 14px; color: rgba(255,255,255,0.6);">
                ...
                <a href="<?php echo e(route('login')); ?>" style="color: #fff; font-weight: 700; text-decoration: none; border-bottom: 2px solid #0EA5E9; padding-bottom: 2px;">Sign in</a>
            </div>
...
<?php /**PATH H:\MAMP\htdocs\unipark\resources\views/auth/register.blade.php ENDPATH**/ ?>